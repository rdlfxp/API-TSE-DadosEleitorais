...
class CandidateSummaryResponse(BaseModel):
    ...
    turno_referencia: int | None = None
    latest_vote_round: int | None = Field(default=None, description="Alias explicito do turno efetivamente usado para o voto de referencia.")
    latest_vote_value: int | None = Field(default=None, description="Valor de votos efetivamente usado como referencia.")
